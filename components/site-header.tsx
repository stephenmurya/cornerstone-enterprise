    ...
    <header className="sticky top-0 z-50 border-b border-white/80 bg-white/80 backdrop-blur-xl">
      ...
      {isMobileMenuOpen ? (
        <div className="lg:hidden">
          ...
          />
          <div className="fixed inset-y-0 left-0 z-50 flex w-[88%] max-w-sm flex-col border-r border-slate-200 bg-white shadow-2xl">
            ...
            <div className="flex-1 space-y-6 overflow-y-auto px-5 py-6">
              ...
              <nav className="space-y-2">
                <MobileMenuLink href="/" onNavigate={() => setIsMobileMenuOpen(false)}>
                  Home
                </MobileMenuLink>
                <MobileMenuLink
                  href="/shop"
